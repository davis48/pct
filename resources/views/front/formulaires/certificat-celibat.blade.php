...
<head>
    ...
    <title>Formulaire - Certificat de Célibat</title>
    <style>
...
<body>
    <div class="header">
        <h2>FORMULAIRE DE DEMANDE DE CERTIFICAT DE CÉLIBAT</h2>
    ...
    <form>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <label for="declaration">Je déclare sur l'honneur être célibataire (jamais marié(e)) et que toutes les informations fournies sont exactes</label>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <textarea style="width: 400px; height: 60px;" placeholder="Précisez l'usage prévu du certificat de célibat"></textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <ul>
                <li>Copie de votre CNI</li>
                <li>Certificat de résidence</li>
                <li>Photo d'identité récente</li>
                <li>Extrait d'acte de naissance récent (moins de 3 mois)</li>
