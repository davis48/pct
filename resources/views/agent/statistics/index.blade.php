            ...
            <div class="grid grid-cols-7 gap-2 mb-4">
                ...
                <div class="text-center">
                    ...
                    <div class="bg-blue-100 rounded-lg p-3 relative">
                        <div class="text-lg font-bold text-blue-600">{{ $day['processed'] }}</div>                        @if($day['processed'] > 0)
                            @php
                                $processedValues = array_column($weeklyPerformance, 'processed');
                                $maxProcessed = !empty($processedValues) ? max($processedValues) : 1;
                                $maxProcessed = $maxProcessed > 0 ? $maxProcessed : 1;
                                $percentage = min(($day['processed'] / $maxProcessed) * 100, 100);
                            @endphp
