...
@section('title', 'Rappels de demandes')

@section('header')
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-white">Rappels de demandes</h1>
...
<div class="space-y-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6">
            <form action="{{ route('agent.requests.reminders') }}" method="GET" class="flex space-x-4">
                <div class="flex-1">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
            <h3 class="text-lg leading-6 font-medium text-gray-900">
                Demandes nécessitant un rappel ({{ $requests->total() }})
            </h3>
            <div class="text-sm text-gray-500">
                <i class="fas fa-info-circle mr-1"></i>
                Demandes en attente depuis plus de 3 jours
            </div>
        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center">
                                <div class="bg-red-100 text-red-800 px-2.5 py-0.5 rounded-full text-xs font-medium">
                                    Rappel nécessaire
                                </div>
                            ...
                            <div class="mt-2 sm:flex sm:justify-between">
                                ...
                                <div class="mt-2 flex items-center text-sm text-red-500 sm:mt-0">
                                    <i class="fas fa-exclamation-triangle flex-shrink-0 mr-1.5 h-4 w-4"></i>
                                    <p>
                                        En attente depuis {{ $request->created_at->diffInDays() }} jours
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            @empty
                <div class="px-4 py-5 sm:p-6 text-center">
                    <div class="text-gray-500">
                        <i class="fas fa-thumbs-up text-xl mb-2"></i>
                        <p>Aucune demande ne nécessite de rappel. Excellent travail !</p>
                    </div>
                </div>
            @endforelse
        </div>
