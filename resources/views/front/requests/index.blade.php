                            ...
                            <td class="py-4 px-6">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        <i class="fas fa-download mr-1"></i> Prêt
                                    </span>
                                    @endif
                                </div>
                            </td>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-start mb-4">                        <div>
                        ...
                        </div>@if($request->status == 'pending' || $request->status == 'en_attente')
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800">
                            <span class="w-2 h-2 bg-yellow-400 rounded-full mr-2 animate-pulse"></span>
                            En attente
                        </span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (readyDocuments > 0) {
        ...
        toast.className = 'fixed top-4 right-4 bg-green-600 text-white px-6 py-4 rounded-lg shadow-lg z-50 max-w-sm';
        toast.innerHTML = `
            <div class="flex items-center">
                <i class="fas fa-check-circle mr-3"></i>
                <div>
                    <div class="font-semibold">Documents prêts !</div>
                    <div class="text-sm text-green-100">
                        Vous avez ${readyDocuments} document${readyDocuments > 1 ? 's' : ''} prêt${readyDocuments > 1 ? 's' : ''} au téléchargement
                    </div>
                </div>
                <button onclick="this.parentElement.parentElement.remove()" class="ml-4 text-green-100 hover:text-white">
