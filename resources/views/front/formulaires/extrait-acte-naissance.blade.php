...
<head>
    ...
    <title>Formulaire - Extrait d'Acte de Naissance</title>
    <style>
...
<body>
    <div class="header">
        <h2>FORMULAIRE DE DEMANDE D'EXTRAIT D'ACTE DE NAISSANCE</h2>
        <p>Mairie de [Nom de la commune]</p>
    </div>

    <form>
        <div class="form-section">
            <h3>INFORMATIONS SUR LA PERSONNE CONCERNÉE</h3>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                ...
                <select>
                    ...
                    <option value="interesse">Intéressé(e)</option>
        ...
        <div class="form-section">
            <h3>USAGE DE L'EXTRAIT</h3>
            
            <div class="form-row">
                <label>Motif de la demande :</label>
                <textarea style="width: 400px; height: 60px;" placeholder="Précisez l'usage prévu de l'extrait d'acte de naissance"></textarea>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <ul>
                ...
                <li>Justificatif de filiation si nécessaire</li>
