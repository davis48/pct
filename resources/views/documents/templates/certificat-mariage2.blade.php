...
<body>
    ...
    <div class="content">
        <p>Nous, Maire de la {{ $commune }}, Officier de l'État Civil, certifions qu'il a été célébré devant nous le mariage ci-après :</p>

        <div class="info-section">
            <div><span class="info-label">Époux :</span> {{ strtoupper($user->nom) }} {{ ucfirst($user->prenoms) }}</div>
            <div><span class="info-label">Né le :</span> {{ \Carbon\Carbon::parse($user->date_naissance)->format('d/m/Y') }}</div>
        ...
        <div class="info-section">
            <div><span class="info-label">Épouse :</span> [À remplir lors de la célébration]</div>
            <div><span class="info-label">Date du mariage :</span> [À remplir lors de la célébration]</div>
            <div><span class="info-label">Lieu du mariage :</span> {{ $commune }}</div>
        </div>

        <p>En foi de quoi nous avons délivré le présent certificat pour servir et valoir ce que de droit.</p>
